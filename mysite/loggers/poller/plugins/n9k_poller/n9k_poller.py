...
class N9k_Poller(object):
    ...
    def __init__(self):
        ...
        with open(os.path.abspath("poller/plugin/n9k_poller/n9k_poller_config.json")) as fin:
    ...
    def process_buffers_details(self, buff_details):
        ...
        for item in sorted_buff_details:
            ...
            mod_instant_peak_util = round((mod_instant_peak * 100.0) / mod_instant_total, 4)
            ...
            for interface, compute in interfaces.items():
                ...
                if interface_details:
                    for key, value in self.stats.items():
                        if interface_details[self.stats[key]]:
                            temp_dict[str(key)] = str(interface_details[value])
